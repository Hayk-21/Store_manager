...
LOCATION_NOT_LIVE = (
    "⚠️ Այս տեղորոշումը ձեռքով է նշված քարտեզի վրա։\n\n"
    "Համակարգն ընդունում է միայն հեռախոսի <b>իրական</b> տեղորոշումը։ "
    "Սեղմեք ներքևի «{button}» կոճակը — այն ուղարկում է ձեր ընթացիկ դիրքը։"
)
LOCATION_FORWARDED = (
