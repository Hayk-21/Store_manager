...
**`counted` is not capped by the till.** It is a reading of a real drawer, which can
hold more than the books say — a sale entered late, change put back. The books are
frozen beside it as `expected`, and `Ղեկավարին` is floored at zero, so an evening the
drawer came up over hands the owner nothing rather than showing them a negative.
