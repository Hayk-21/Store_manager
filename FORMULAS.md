...
not capped: they may know of a sale nobody entered. `Ղեկավարին` is floored at zero
either way, so a count that does get above the books hands over nothing rather than a
negative.
